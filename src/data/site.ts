    ...
    snapshot: {
      ...
      beats: [
        ...
        },
        {
          ...
          figureSrc: "/images/case-studies/future-map.png",
          figureCaption: "Future state: the self-service map builder, designed but not yet shipped.",
          secondaryFigureSrc: "/images/case-studies/rollout.png",
          secondaryFigureCaption: "Rolled out to 208 marinas.",
        },
      ],
    },
    content: {
